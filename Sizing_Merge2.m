...
function [D_p, dNdlogD_p] = Sizing_Merge2(D_m, dNdlogD_m, D_a, dNdlogD_a)
...
ScalingPower = 1; % 1 = unbiased scaling, 2 = preferential SMPS scaling, 0.5 = preferential APS scaling
